...
public class StudentNameAdapter extends BaseAdapter {
    ...
    private List<ModelStudentlist> items;
    ...
    public StudentNameAdapter(Context context, int resource,
                              List<ModelStudentlist> items, String selected_id) {
        this.items = items;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ModelStudentlist api_Info = items.get(position);
     ...
     /*   holder.prompt_other.setOnFocusChangeListener(new View.OnFocusChangeListener() {
        ...
        String st_id = api_Info.getSTUDENT_ADMISSION_NO();
        String st_name = api_Info.getSTUDENT_FIRST_NAME();


        holder.classname.setText(st_name);
