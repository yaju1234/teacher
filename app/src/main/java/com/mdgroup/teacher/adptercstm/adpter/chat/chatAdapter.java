...
import com.mdgroup.teacher.schoolmodel.ModelStudentlist;
...
public class chatAdapter extends RecyclerView.Adapter<chatAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView teacher_name, teacher_sub, NEWS_UPLOAD_DATE,teacher_time_chat,arrow;
        ...
        public MyViewHolder(View view) {
            ...
            teacher_time_chat = (TextView) view.findViewById(R.id.teacher_time_chat);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.teacher_time_chat.setText(chat.getLAST_MSG_TIME()!=null?chat.getLAST_MSG_TIME():"");

        int count = 0;
        if(chat.getTOTAL_MSG_COUNT()!=null){

            if(chat.getTOTAL_MSG_COUNT() instanceof  Integer){
                count = (Integer)chat.getTOTAL_MSG_COUNT();
            }else{
                count  = Integer.parseInt((String)chat.getTOTAL_MSG_COUNT());
            }
